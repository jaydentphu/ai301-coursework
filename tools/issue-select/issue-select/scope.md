...
Comfortable with Python, Git, and GitHub. I build automation pipelines
and internal tooling (Notion-based systems, backend integrations) in an
AI/automation internship, so I'm most confident in Python and scripting/
automation-style code. Less experience with frontend frameworks or
languages outside Python. I'd like to get better at reading unfamiliar
codebases and working with test suites I didn't write. I'd rather avoid
issues that are purely CSS/UI styling with no logic involved.
